...
<br/>🔒 Can encrypt your notes. You need to set a password at the settings and use Android device with version Kitkat or newer. You can use [jpencconverter](https://gitlab.com/opensource21/jpencconverter) to encrypt/decrypt easy on desktop. Be aware that only the text is encrypted not pictures or attachments. AES256 encryption is used. 
