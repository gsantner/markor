...
public class Constants {
    ...
    public static final String[] KEYBOARD_EXTRA_ACTIONS = {"----\n","[ ]( ) "};
    public static final int[][] KEYBOARD_EXTRA_ACTIONS_ICONS ={{R.drawable.format_horizontal_line,0},{R.drawable.format_link,1}};
