...
public class NewFileDialog extends DialogFragment {
    ...
    private static final DateFormat TIMESTAMP_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ", Locale.US);
    ...
    private AlertDialog.Builder makeDialog(final File basedir, LayoutInflater inflater) {
        ...
        dialogBuilder
                .setPositiveButton(getString(android.R.string.ok), (dialogInterface, i) -> {
                    ...
                    String templateContents = getTemplateContent(templateSpinner, fileNameEdit.getText().toString());
    ...
    private String getTemplateContent(Spinner templateSpinner, String title) {
        ...
        if (template != null) {
            ...
            template = template.replaceAll("\\{timestamp\\}", TIMESTAMP_FORMAT.format(new Date()));
        }
        return template;
    }
}
