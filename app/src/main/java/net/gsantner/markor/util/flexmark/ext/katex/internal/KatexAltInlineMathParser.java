...
public class KatexAltInlineMathParser implements InlineParserExtension {
    Pattern MATH_PATTERN = Pattern.compile("\\\\\\(((?:.|\n)+?)\\\\\\)");
    private final KatexOptions options;

    public KatexAltInlineMathParser(final InlineParser inlineParser) {
    ...
    public boolean parse(final InlineParser inlineParser) {
        if (inlineParser.peek(1) == '(') {
            ...
            if (matcher != null) {
                ...
                KatexAltInlineMath inlineMath = new KatexAltInlineMath(mathOpen, mathOpen.baseSubSequence(mathOpen.getEndOffset(),mathClosed.getStartOffset()), mathClosed);
    ...
    public static class Factory implements InlineParserExtensionFactory {
        ...
        public InlineParserExtension create(final InlineParser inlineParser) {
            return new KatexAltInlineMathParser(inlineParser);
        }
