...
//                new ActionItem(R.string.abid_asciidoc_table_insert_columns, R.drawable.ic_view_module_black_24dp, R.string.table),
                ...
                new ActionItem(R.string.abid_asciidoc_thematic_break, R.drawable.ic_more_horiz_black_24dp, R.string.horizontal_line),
                ...
                // TODO: these are markdown action buttons, adapt for asciidoc
...
//                new ActionItem(R.string.abid_common_rotate_screen, R.drawable.ic_rotate_left_black_24dp, R.string.rotate, ActionItem.DisplayMode.ANY),
    ...
    public boolean onActionClick(final @StringRes int action) {
        switch (action) {
            ...
            // case R.string.abid_asciidoc_h6: {
            //     runRegexReplaceAction(AsciidocReplacePatternGenerator.setOrUnsetHeadingWithLevel(6));
            //     return true;
            // }
            // ** vs only *
            ...
            case R.string.abid_asciidoc_thematic_break: {
                runInlineAction("'''\n");
                return true;
            }
            case R.string.abid_asciidoc_page_break: {
                runInlineAction("<<<\n");
                return true;
            }
...
//            case R.string.abid_asciidoc_block_quote: {
//                runRegexReplaceAction(AsciidocReplacePatternGenerator.toggleQuote());
//                return true;
//            }
