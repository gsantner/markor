...
public class MarkdownTextConverter extends TextConverter {
    ...
    public static final String EXT_MARKDOWN__HTML = ".html";
    ...
    public static final Pattern MD_EXTENSION_PATTERN = Pattern.compile("((?i)\\.((md)|(markdown)|(mkd)|(mdown)|(mkdn)|(txt)|(mdwn)|(text)|(rmd)|(html))$)");
    public static final String[] MD_EXTENSIONS = new String[]{
            ...
            EXT_MARKDOWN__RMD, EXT_MARKDOWN__MD_TXT,EXT_MARKDOWN__HTML
    };
