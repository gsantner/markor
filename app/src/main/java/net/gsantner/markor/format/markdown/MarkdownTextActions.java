...
public class MarkdownTextActions extends TextActions {
    ...
    private static final int[][] TMA_ACTIONS = {
            ...
            {R.string.tmaid_markdown_bold, R.drawable.ic_format_bold_black_24dp, R.string.markdown_bold},
            {R.string.tmaid_markdown_italic, R.drawable.ic_format_italic_black_24dp, R.string.markdown_italic},
            ...
            {R.string.tmaid_markdown_code_inline, R.drawable.ic_code_black_24dp, R.string.markdown_code_inline},
            ...
            {R.string.tmaid_markdown_table_insert_columns, R.drawable.ic_view_module_black_24dp, R.string.markdown_table_insert_columns},
            {R.string.tmaid_markdown_quote, R.drawable.ic_format_quote_black_24dp, R.string.markdown_quote},
            {R.string.tmaid_markdown_h1, R.drawable.format_header_1, R.string.markdown_h1},
            {R.string.tmaid_markdown_h2, R.drawable.format_header_2, R.string.markdown_h2},
            {R.string.tmaid_markdown_h3, R.drawable.format_header_3, R.string.markdown_h3},
            {R.string.tmaid_markdown_horizontal_line, R.drawable.ic_more_horiz_black_24dp, R.string.markdown_horizontal_line},
    };
