...
public class TodoTxtTextActions extends TextActions {
    ...
    private static final int[][] TMA_ACTIONS = {
            {R.string.tmaid_todotxt_toggle_done, R.drawable.ic_check_box_black_24dp, R.string.todotxt_toggle_done},
            {R.string.tmaid_todotxt_add_context, R.drawable.gs_email_sign_black_24dp, R.string.todotxt_add_context},
            {R.string.tmaid_todotxt_add_project, R.drawable.ic_local_offer_black_24dp, R.string.todotxt_add_project},
            {R.string.tmaid_todotxt_priority, R.drawable.ic_star_border_black_24dp, R.string.todotxt_priority},
            ...
            {R.string.tmaid_todotxt_archive_done_tasks, R.drawable.ic_archive_black_24dp, R.string.todotxt_archive_done_tasks},
            {R.string.tmaid_todotxt_sort_todo, R.drawable.ic_sort_by_alpha_black_24dp, R.string.todotxt_sort_todo},
            {R.string.tmaid_todotxt_current_date, R.drawable.ic_date_range_black_24dp, R.string.todotxt_current_date},
    };
