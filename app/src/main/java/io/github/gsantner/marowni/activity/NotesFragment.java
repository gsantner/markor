...
import io.github.gsantner.marowni.adapter.NotesAdapter;
...
public class NotesFragment extends Fragment {
    ...
    private MarowniSingleton marowniSingleton;
    ...
    public void onResume() {
        marowniSingleton = MarowniSingleton.getInstance();
    ...
    private void retrieveCurrentFolder() {
        ...
        if (currentDir == null) {
            currentDir = (marowniSingleton.getNotesLastDirectory() != null) ? marowniSingleton.getNotesLastDirectory() : rootDir;
        }
    }
    ...
    private void reloadFiles(File directory) {
        ...
        try {
            // Load from SD card
            filesCurrentlyShown = MarowniSingleton.getInstance().addFilesFromDirectory(directory, new ArrayList<File>());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void showEmptyDirHintIfEmpty() {
        if (marowniSingleton.isDirectoryEmpty(filesCurrentlyShown)) {
    ...
    public boolean onRooDir() {
        return marowniSingleton.isRootDir(currentDir, rootDir);
    }
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            if (file.isDirectory()) {
                ...
                if (AppSettings.get().isPreviewFirst()) {
                    ...
                    String content = MarowniSingleton.getInstance().readFileUri(noteUri, context);
